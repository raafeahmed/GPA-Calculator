...
void GPA::readInput()
{
    ...
    do
    {
        ...
        case 'P':
            ...
            case 's':
            {
                ...
                std::cout << "MSH: " << it->second.semester_hours << "\n";
            ...
            case 'c':
                credits = printCumulative(command);
                break;
            default:
                break;
            }
    ...
    if (credits < 120)
        ...
        std::cout << "Congratulations on graduating!\n";
}
...
double GPA::printCumulative(std::string &command)
{
    ...
    case 'F':
    {
        ...
        for (uint32_t i = 0; i < num_semesters; ++i)
        {
            ...
            cumulative_hours += it->second.semester_hours;
    ...
    case 'A':
        for (auto x : transcript)
        {
            ...
            cumulative_hours += x.second.semester_hours;
